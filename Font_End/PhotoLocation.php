...
$query = $conn->prepare("SELECT * FROM vendor WHERE service_type = 'Photo Location'");
$query->execute();
$vendors = $query->fetchAll(PDO::FETCH_ASSOC);
?>

<section class="Photo Location">
    <h1 class="heading">Photo Location</h1>
    ...
    <div class="box-container">
        <?php if (count($vendors) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p style="text-align: center;">No Photo Location found.</p>
        <?php endif; ?>
    </div>
</section>
