...
// Fetch Wedding Cars
$query = $conn->prepare("SELECT * FROM vendor WHERE service_type = 'Wedding Cars'");
$query->execute();
$vendors = $query->fetchAll(PDO::FETCH_ASSOC);
?>

<section class="Wedding Cars">
    <h1 class="heading">Wedding Cars</h1>
    ...
    <div class="box-container">
        <?php if (count($vendors) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p style="text-align: center;">No Wedding Cars found.</p>
        <?php endif; ?>
    </div>
</section>
