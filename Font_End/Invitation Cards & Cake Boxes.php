...
<head>
    ...
    <title>Invitation Cards & Cake Boxes</title>
...
// Fetch Invitation Cards & Cake Boxes
$query = $conn->prepare("SELECT * FROM vendor WHERE service_type = 'Invitation Cards & Cake Boxes'");
$query->execute();
$vendors = $query->fetchAll(PDO::FETCH_ASSOC);
?>

<section class="Invitation Cards & Cake Boxes">
    <h1 class="heading">Invitation Cards & Cake Boxes</h1>
    ...
    <div class="box-container">
        <?php if (count($vendors) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p style="text-align: center;">No Invitation Cards & Cake Boxes found.</p>
        <?php endif; ?>
    </div>
</section>
