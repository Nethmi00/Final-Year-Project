...
<head>
    ...
    <title>Traditional Events</title>
...
$query = $conn->prepare("SELECT * FROM vendor WHERE service_type = 'Traditional Events'");
$query->execute();
$vendors = $query->fetchAll(PDO::FETCH_ASSOC);
?>

<section class="Traditional Events">
    <h1 class="heading">Traditional Events</h1>
    ...
    <div class="box-container">
        <?php if (count($vendors) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p style="text-align: center;">No Traditional Events found.</p>
        <?php endif; ?>
    </div>
</section>
