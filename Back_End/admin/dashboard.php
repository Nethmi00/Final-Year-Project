...
<div class="box-container">
   ...
   <div class="box">
      <?php
         $count_couple = $conn->prepare("SELECT * FROM `couple`");
         $count_couple ->execute();
         $total_couple  = $count_couple ->rowCount();
      ?>
      <h3><?= $total_admins; ?></h3>
      <p>Total Registered couples </p>
      <a href="Register.php" class="btn">view accounts</a>
   </div>
