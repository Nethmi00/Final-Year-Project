...
// Fetch Videographers
$query = $conn->prepare("SELECT * FROM vendor WHERE service_type = 'Videographer'");
$query->execute();
$vendors = $query->fetchAll(PDO::FETCH_ASSOC);
?>

<section class="Videographers">
    <h1 class="heading">Videographers</h1>
    ...
    <div class="box-container">
        <?php if (count($vendors) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p style="text-align: center;">No Videographers found.</p>
        <?php endif; ?>
    </div>
</section>
