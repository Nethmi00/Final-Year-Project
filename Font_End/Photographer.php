...
// Fetch Photographers
$query = $conn->prepare("SELECT * FROM vendor WHERE service_type = 'Photographer'");
$query->execute();
$vendors = $query->fetchAll(PDO::FETCH_ASSOC);
?>

<section class="Photographers">
    <h1 class="heading">Photographers</h1>
    ...
    <div class="box-container">
        <?php if (count($vendors) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p style="text-align: center;">No Photographers found.</p>
        <?php endif; ?>
    </div>
</section>
