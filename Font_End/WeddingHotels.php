...
// Fetch Wedding Hotels
$query = $conn->prepare("SELECT * FROM vendor WHERE service_type = 'Wedding Hotel'");
$query->execute();
$vendors = $query->fetchAll(PDO::FETCH_ASSOC);
?>

<section class="hotels">
    <h1 class="heading">Wedding Hotels</h1>
    ...
    <div class="box-container">
        <?php if (count($vendors) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p style="text-align: center;">No wedding hotels found.</p>
        <?php endif; ?>
    </div>
</section>
